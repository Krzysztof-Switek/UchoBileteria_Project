...
urlpatterns = [
    ...
    path("wejscie/<int:event_id>/cofnij/", views.undo_check_in, name="undo_check_in"),
    ...
    path(
        "wejscie/<int:event_id>/tryb-offline.json",
        views.offline_manifest,
        name="offline_manifest",
    ),
    path(
