"""
Django settings for the UCHO ticketing system.

All deployment-specific values come from environment variables (or a .env
file in the project root). Defaults are safe for local development only.
"""
...
# SQLite for local development; set DATABASE_URL=postgres://... in production.
DATABASES = {
...
# Email: console backend by default; in dev use Mailpit (smtp://localhost:1025),
# in production a real SMTP provider.
EMAIL_CONFIG = env.email_url("EMAIL_URL", default="consolemail://")
vars().update(EMAIL_CONFIG)
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="bilety@example.com")
